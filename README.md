...
- **Copy page for AI:** copy the complete chapter as Markdown, then paste it into any assistant and add your question. A Markdown download is also available; no AI service is embedded in the course. See [copying a page and its limits](STUDY_HANDOFF_2026-09-14.md).
