...
- Chapter-stage navigation and completion indicators must use the active track. Verify actual destinations and current-topic labels in the survey as well as the deep dive; chapter numbers are not interchangeable. Remove repeated decorative captions and encouragement when they add no reading value, while preserving useful controls, source attribution and scientific qualifications.
